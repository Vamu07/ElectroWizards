...
include __DIR__ . "/../../config/conexion.php"; // conexión correcta
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(empty($errores)){
        ...
        // Consulta corregida (ahora incluye id_usuario)
...
// traer categorias dinámicamente
$cats=[];
